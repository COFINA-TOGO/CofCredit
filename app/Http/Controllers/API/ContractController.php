 ...
 * @group Contrat
 *
 * EndPoints pour gérer les contrat
 */
class ContractController extends Controller
{
    ...
    public function word(Request $request, int $id)
    {
        ...
        if ($contract) {
            // if (($authorisation = Gate::inspect('view', $contract))->allowed()) {
            $templatePath = ($contract->has_pledges == "false") ? "../storage/app/public/templates/$contract->type/contract_$contract->type.docx" : "../storage/app/public/templates/$contract->type/with_pledge/contract_$contract->type" . "_with_pledge.docx";
    ...
    public function promissory_note(Request $request, int $id)
    {
        ...
        if ($contract) {
            ...
            $templateProcessor = new TemplateProcessor("../storage/app/public/templates/$contract->type/billet_a_ordre_$contract->type.docx");
