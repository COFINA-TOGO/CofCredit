...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('contracts', function (Blueprint $table) {
            ...
            $table->enum("representative_type_of_identity_document", ["cni", "passport", "residence_certificate", "driving_licence", "consular_card", "ECOWAS_identity_card", "residence_permit"])->default('cni');
