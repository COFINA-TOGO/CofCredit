...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'pv-notification-add': RouteRecordInfo<'pv-notification-add', '/pv/notification/add', Record<never, never>, Record<never, never>>,
    'pv-notification-check-id': RouteRecordInfo<'pv-notification-check-id', '/pv/notification/check/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'pv-notification-edit-id': RouteRecordInfo<'pv-notification-edit-id', '/pv/notification/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'pv-notification-historical': RouteRecordInfo<'pv-notification-historical', '/pv/notification/historical', Record<never, never>, Record<never, never>>,
    'pv-notification-without-pv': RouteRecordInfo<'pv-notification-without-pv', '/pv/notification/without-pv', Record<never, never>, Record<never, never>>,
