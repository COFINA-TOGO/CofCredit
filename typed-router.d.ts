...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'notification-contract_id-guarantor': RouteRecordInfo<'notification-contract_id-guarantor', '/notification/:contract_id/guarantor', { contract_id: ParamValue<true> }, { contract_id: ParamValue<false> }>,
    'notification-contract_id-guarantor-id': RouteRecordInfo<'notification-contract_id-guarantor-id', '/notification/:contract_id/guarantor/:id', { contract_id: ParamValue<true>, id: ParamValue<true> }, { contract_id: ParamValue<false>, id: ParamValue<false> }>,
    'notification-contract_id-guarantor-add': RouteRecordInfo<'notification-contract_id-guarantor-add', '/notification/:contract_id/guarantor/add', { contract_id: ParamValue<true> }, { contract_id: ParamValue<false> }>,
    'notification-contract_id-guarantor-edit-id': RouteRecordInfo<'notification-contract_id-guarantor-edit-id', '/notification/:contract_id/guarantor/edit/:id', { contract_id: ParamValue<true>, id: ParamValue<true> }, { contract_id: ParamValue<false>, id: ParamValue<false> }>,
    ...
    'notification-waiting-cat': RouteRecordInfo<'notification-waiting-cat', '/notification/waiting_cat', Record<never, never>, Record<never, never>>,
