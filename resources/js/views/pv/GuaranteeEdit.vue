...
<template>
	<VCard flat border class="d-flex flex-row">
		...
		<div class="pa-5 flex-grow-1">
			<VRow>
				<VCol cols="12">
					<AppSelect v-model="localGuaranteeData.type_of_guarantee_id" :items="typeOfGuaranteeList"
						item-title="name" item-value="id" label="Type de cautionie"
						placeholder="Choisir le type de cautionie" class="mb-3" :rules="[requiredValidator]" />
				</VCol>
			</VRow>
			<VRow>
				<VCol cols="12">
