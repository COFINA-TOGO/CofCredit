							...
							<VRow>
								<VCol cols="12" md="6" lg="6">
									<AppAutocomplete v-model="cat.notification_id" :items="notificationList"
										:error-messages="catError.notification_id" label="Contrat"
										placeholder="Ex: CFNTG-044-13-12-23-01212" :rules="[requiredValidator]"
										item-title="verbal_trial.label" item-value="id" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
									<AppTextField type="number" v-model="cat.guarantees_total_amount"
										:error-messages="catError.guarantees_total_amount"
										label="Montant total des garanties" placeholder="Ex: 1500000"
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="cat.guarantees_total_amount"
										:error-messages="catError.guarantees_total_amount"
										label="Montant total des garanties" placeholder="Ex: 25000000"
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="cat.credit_number" :error-messages="catError.credit_number"
										label="Numéro du crédit" placeholder="Ex: 485632"
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
								...
								<VCol cols="12" md="6" lg="6">
									<AppDateTimePicker v-model="cat.first_deadline"
										:error-messages="catError.first_deadline" label="Date de première échéance"
										placeholder="Ex: 2024-02-02" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
									<AppDateTimePicker v-model="cat.last_deadline"
										:error-messages="catError.last_deadline" label="Date de dernière échéance"
										placeholder="Ex: 2024-02-02" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="cat.outstanding_number_ready_to_settle"
										:error-messages="catError.outstanding_number_ready_to_settle"
										label="Numéro encours prêt à solder" placeholder="Ex: "
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
								...
								<VCol cols="12" md="12" lg="12">
									<AppTextarea v-model="cat.instructions_from_the_risk_and_credit_department"
										...
										label="Instructions du département risque et crédit" placeholder="Ex: "
										:rules="[requiredValidator]" clearable counter />
								</VCol>
							</VRow>
						</VCardText>
					</VCard>
