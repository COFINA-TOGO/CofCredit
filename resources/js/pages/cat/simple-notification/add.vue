...
const cat = ref({
	...
	"first_deadline":null,
	"last_deadline":null,
	"source_of_reimbursement":null,
	"instructions_from_the_risk_and_credit_department":null,
					...
					<VCard class="mb-6" title="Information sur CAT">
						<VCardText>
							<VRow>
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField type="number" v-model="cat.other_expenses"
										:error-messages="catError.other_expenses" label="Autres frais"
