			...
			<VDataTableServer v-model:items-per-page="itemsPerPage" v-model:page="page" :headers="headers"
				...
				<template #item.actions="{ item }">
					<div class="text-center">
							...
							<VBtn icon variant="text" size="small" color="medium-emphasis">
								...
								<VMenu activator="parent">
									<VList>
										...
										<div
											v-if="$can('upload', 'basic-contract') && (item.signed_contract_path == null || item.signed_promissory_note_path == null || item.status == 'rejected')">
											<VDivider />
						...
						<span v-if="
							$can('update', 'basic-contract') || $can('delete', 'basic-contract')
						">
							<VDivider />
							<IconBtn v-if="$can('update', 'basic-contract')" :to="{
							...
							<IconBtn v-if="$can('delete', 'basic-contract')" @click="
