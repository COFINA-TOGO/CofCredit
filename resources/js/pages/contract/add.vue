							...
							<VRow>
								<VCol cols="12" md="6" lg="4">
									<AppDateTimePicker
										...
										:error-messages="
											formError.representative_birth_date
										"
								...
								<VCol cols="12" md="6" lg="4">
									<AppTextField
										...
										:error-messages="
											formError.representative_birth_place
										"
								...
								<VCol cols="12" md="6" lg="4">
									<AppTextField
										...
										:error-messages="
											formError.representative_nationality
										"
										label="Nationalité"
										:rules="[requiredValidator]"
									/>
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField
										...
										:error-messages="
											formError.representative_phone_number
										"
						...
						<VCardText>
							<VRow cols="12">
								<VCol cols="12" md="6" lg="6">
									<AppTextField
										v-model="
											contractData.individual_business_denomination
										"
										:error-messages="
											formError.individual_business_denomination
										"
										label="Dénomination"
										:rules="[requiredValidator]"
									/>
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField
										v-model="
											contractData.individual_business_rccm_number
										"
										:error-messages="
											formError.individual_business_rccm_number
										"
										label="Numero RCCM"
										:rules="[requiredValidator]"
									/>
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField
										v-model="
											contractData.individual_business_phone_number
										"
										:error-messages="
											formError.individual_business_phone_number
										"
										label="Telephone de la société"
										:rules="[requiredValidator]"
									/>
								...
								<VCol cols="12">
									<AppTextField
										v-model="
											contractData.individual_business_corporate_purpose
										"
										:error-messages="
