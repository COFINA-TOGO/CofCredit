					...
					<VCard class="mb-6" title="Information sur contrat">
						<VCardText>
							<VRow>
								...
								<VCol cols="12" md="4" lg="4">
									<AppTextField v-model="contractData.due_amount" type="number"
										:error-messages="formError.due_amount" label="Montant d'une échéance"
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="4" lg="4">
									<AppSelect v-model="contractData.type" :items="typeList"
										:error-messages="formError.type" label="Type" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="10">
								...
								<VCol cols="2">
									<VCheckbox v-model="contractData.has_pledges" :true-value="'1'" :false-value="'0'"
										...
										:error-messages="formError.has_pledges" true-icon="tabler-check"
							...
							<VRow>
								...
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="contractData.representative_home_address"
										...
										label="Addresse du domicile" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppSelect v-model="contractData.representative_type_of_identity_document"
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="contractData.representative_phone_number"
										...
										label="Numéro de téléphone" :rules="[requiredValidator]" />
								</VCol>
							</VRow>
						</VCardText>
					</VCard>
							...
							<VRow cols="12">
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="contractData.company_rccm_number"
										:error-messages="formError.company_rccm_number" label="Numero RCCM"
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
								...
								<VCol cols="12">
									<AppTextField v-model="contractData.company_head_office_address"
										...
										label="Addresse du siège social" :rules="[requiredValidator]" />
								</VCol>
							</VRow>
						</VCardText>
					</VCard>
							...
							<VRow cols="12">
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="contractData.individual_business_denomination"
										...
										label="Dénomination" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="contractData.individual_business_head_office_address"
										:error-messages="formError.individual_business_head_office_address"
										label="Addresse du siège social" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="6">
								...
								<VCol cols="12" md="6" lg="6">
									<AppTextField v-model="contractData.individual_business_phone_number"
										...
										label="Telephone de la société" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12">
									<AppTextField v-model="contractData.individual_business_corporate_purpose"
										:error-messages="formError.individual_business_corporate_purpose"
										label="Objet social" :rules="[requiredValidator]" />
								</VCol>
							</VRow>
						</VCardText>
					</VCard>
