...
const route = useRoute('notification-notification_id-guarantor-edit-id')
    ...
    if (valid) {
      const res = await $api(`/guarantor/${route.params.id}`, {
        ...
        body: {
          ...
          type_of_identity_document: guarantorItem.value.type_of_identity_document,
          number_of_identity_document: guarantorItem.value.number_of_identity_document,
          date_of_issue_of_identity_document: guarantorItem.value.date_of_issue_of_identity_document,
      ...
      <VRow>
        ...
        <VCol cols="1">
          <VBtn prepend-icon='tabler-eye'
            :to="{ name: 'notification-notification_id-guarantor-id', params: { notification_id: route.params.notification_id, id: route.params.id } }">
            Voir
          </VBtn>
        </VCol>
      </VRow>
            ...
            <VCardText>
              <VRow>
                <VCol cols="12" md="6" lg="4">
                  <AppSelect v-model="guarantorItem.civility" :items="civilityItemList"
                    :error-messages="guarantorError.civility" label="Civilité" placeholder="Ex: Mr"
                    :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppTextField v-model="guarantorItem.first_name" :error-messages="guarantorError.first_name"
                    label="Prénom" placeholder="Ex: Cesar" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppTextField v-model="guarantorItem.last_name" :error-messages="guarantorError.last_name" label="Nom"
                    placeholder="Ex: DEFALGO" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppDateTimePicker v-model="guarantorItem.birth_date" :error-messages="guarantorError.birth_date"
                    label="Date de naissance" placeholder="Ex: 2000-12-12" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppTextField v-model="guarantorItem.birth_place" :error-messages="guarantorError.birth_place"
                    label="Lieu de naissance" placeholder="Ex: Lomé" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppTextField v-model="guarantorItem.nationality" :error-messages="guarantorError.nationality"
                    label="Nationalité" placeholder="Ex: Togolaise" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppTextField v-model="guarantorItem.home_address" :error-messages="guarantorError.home_address"
                    label="Addresse du domicile" placeholder="Ex: Adewi, Lomé" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppSelect v-model="guarantorItem.type_of_identity_document" :items="documentTypeList"
                    :error-messages="guarantorError.type_of_identity_document" label="Type de la pièce d'identité"
                    placeholder="Ex: Passeport" :rules="[requiredValidator]" />
                </VCol>
                <VCol cols="12" md="6" lg="4">
                  <AppTextField v-model="guarantorItem.number_of_identity_document"
