					...
					<VCard class="mb-6" title="Information de la caution">
						<VCardText>
							<VRow>
								...
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.first_name"
										:error-messages="guarantorError.first_name" label="Prénom"
										placeholder="Ex: Cesar" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.last_name"
										:error-messages="guarantorError.last_name" label="Nom" placeholder="Ex: DEFALGO"
										:rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppDateTimePicker v-model="guarantorItem.birth_date"
										:error-messages="guarantorError.birth_date" label="Date de naissance"
										placeholder="Ex: 2000-12-12" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.birth_place"
										:error-messages="guarantorError.birth_place" label="Lieu de naissance"
										placeholder="Ex: Lomé" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.nationality"
										:error-messages="guarantorError.nationality" label="Nationalité"
										placeholder="Ex: Togolaise" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.home_address"
										:error-messages="guarantorError.home_address" label="Addresse du domicile"
										placeholder="Ex: Adewi, Lomé" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppSelect v-model="guarantorItem.type_of_identity_document"
								...
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.function"
										:error-messages="guarantorError.function" label="Fonction"
										placeholder="Ex: Agent de change" :rules="[requiredValidator]" />
								</VCol>
								<VCol cols="12" md="6" lg="4">
									<AppTextField v-model="guarantorItem.phone_number"
										:error-messages="guarantorError.phone_number" label="Numéro de téléphone"
