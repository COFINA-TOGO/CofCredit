...
const pvData = ref({
	...
	account_number: "251000258956",
	activity: "RAS",
	purpose_of_financing: "RAS",
	type_of_credit_id: 1,
	amount: 15000000,
	duration: 22,
	periodicity: "mensual",
							...
							<VRow>
								...
								<VCol cols="12">
									<VSlider v-model="pvData.administrative_fees_percentage" label="Frais de dossier(%)"
										:error-messages="pvError.administrative_fees_percentage" :thumb-size="15"
										thumb-label="always" :rules="[requiredValidator]" step="0.01">
										<template #append>
											<VTextField v-model="pvData.administrative_fees_percentage"
												:error-messages="pvError.administrative_fees_percentage" type="number"
												style="width:120px" density="compact" hide-details variant="outlined"
												suffix="%" />
										</template>
									</VSlider>
								...
								<VCol cols="12">
									<VSlider v-model="pvData.tax_fee_interest_rate" label="Taux d'intérêt HT(%)"
										...
										thumb-label="always" :rules="[requiredValidator]" step="0.01">
										<template #append>
											<VTextField v-model="pvData.tax_fee_interest_rate"
												:error-messages="pvError.tax_fee_interest_rate" type="number"
												style="width:120px" density="compact" hide-details variant="outlined"
												suffix="%" />
										</template>
									</VSlider>
