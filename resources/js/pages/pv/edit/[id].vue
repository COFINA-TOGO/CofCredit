					...
					<VCol md="12">
						...
						<VCard class="mb-6" title="Modification du pv de comité">
							<VCardText>
								<VRow>
									<VCol>
										<VAlert v-if="verbalTrial.status == 'rejected' && verbalTrial.comment"
											color="warning">
								...
								<VRow>
									<VCol cols="12" md="6" lg="4">
										<AppTextField v-model="verbalTrial.committee_id"
											:error-messages="verbalTrialError.committee_id" label="Numéro du comitée"
									...
									<VCol cols="12" md="6" lg="4">
										<AppAutocomplete v-model="verbalTrial.caf_id" :items="cafList"
											:error-messages="verbalTrialError.caf_id" label="Chargé d'affaire"
											placeholder="" item-title="full_name" item-value="id"
									...
									<VCol cols="12" md="6" lg="4">
										<AppAutocomplete v-model="verbalTrial.credit_admin_id" :items="creditAdminList"
											...
											label="Administrateur Crédit" placeholder="" item-title="full_name"
											item-value="id" :rules="[requiredValidator]" />
									</VCol>
									<VCol cols="12" md="6" lg="4">
										<AppAutocomplete v-model="verbalTrial.credit_analyst_id"
											:items="creditAnalystList"
											:error-messages="verbalTrialError.credit_analyst_id" label="Analyste Crédit"
											placeholder="" item-title="full_name" item-value="id"
											:rules="[requiredValidator]" />
									</VCol>
									<VCol cols="12" md="6" lg="4">
									...
									<VCol cols="12" md="6" lg="4">
										<AppTextField v-model="verbalTrial.account_number"
											:error-messages="verbalTrialError.account_number" label="Numéro de compte"
											placeholder="" :rules="[requiredValidator]" />
									</VCol>
									<VCol cols="12" md="6" lg="4">
									...
									<VCol cols="12" md="6" lg="4">
										<AppAutocomplete v-model="verbalTrial.type_of_credit_id"
											...
											placeholder="" item-title="name" item-value="id"
											:rules="[requiredValidator]" />
									</VCol>
									...
									<VCol cols="12" md="6" lg="4">
										<AppTextField v-model="verbalTrial.duration" type="number"
											...
											placeholder="" append-inner-icon="tabler-calendar"
											:rules="[requiredValidator]" />
									</VCol>
									<VCol cols="12" md="6" lg="4">
									...
									<VCol cols="12" md="6" lg="4">
										<AppSelect v-model="verbalTrial.release_type"
											...
											:error-messages="verbalTrialError.release_type" label="Type de deblocage"
											placeholder="" :rules="[requiredValidator]" />
									</VCol>
									<VCol cols="12">
									...
									<VCol cols="12">
										<VSlider v-model="verbalTrial.administrative_fees_percentage"
											...
											:thumb-size="15" thumb-label="always" :rules="[requiredValidator]"
											step="0.01">
											<template #append>
									...
									<VCol cols="12">
										<VSlider v-model="verbalTrial.tax_fee_interest_rate"
											...
											:error-messages="verbalTrialError.tax_fee_interest_rate" :thumb-size="15"
